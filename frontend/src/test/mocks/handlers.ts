...
import {
  ...
  buildEmptyPlayerStatsForPlayers,
  buildEmptyStrategyStats,
  buildEmptyTeamStats,
  buildGamePointTimelineResponse,
  buildTeamEvolutionResponse,
  buildTeamPlayerStatsForScope,
  parseRepeatedIds,
...
function getMockStatisticsData(): MockStatisticsData {
  return {
    competitions,
    competitionPlayers,
    games,
...
export const handlers = [
  ...
  http.get(`${BASE_URL}/statistics/games/:gameId/timeline`, ({ params, request }) => {
    ...
    return HttpResponse.json(buildGamePointTimelineResponse(getMockStatisticsData(), gameId, requiredPlayerIds));
  }),
  ...
  http.get(`${BASE_URL}/statistics/teams/:teamId/players`, ({ params, request }) => {
    ...
    return HttpResponse.json(
      buildTeamPlayerStatsForScope(getMockStatisticsData(), teamId, competitionIds, gameIds, requiredPlayerIds)
    );
  }),
  ...
  http.get(`${BASE_URL}/statistics/teams/:teamId/evolution`, ({ params, request }) => {
    ...
    return HttpResponse.json(
      buildTeamEvolutionResponse(getMockStatisticsData(), teamId, competitionIds, gameIds, requiredPlayerIds)
    );
  }),
